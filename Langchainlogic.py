...
def create_restaurant(input):
    ...
    name_prompt = PromptTemplate(input_variables=['cuisine'],template="Give me 1 creative name for a {cuisine} restaurant that I am planning to open without any numbers or bullets.")
